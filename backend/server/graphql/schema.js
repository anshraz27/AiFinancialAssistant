...
module.exports = buildSchema(`
  ...
  type DashboardAnalytics { user: User!, dashboardSummary: DashboardSummary!, spendingByCategory: [CategorySpend!]!, monthlyCashflow: [Cashflow!]!, budgetHealth: [BudgetHealth!]!, recentTransactions: [Transaction!]! }
